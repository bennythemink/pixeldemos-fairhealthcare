# Snapshot: fair-healthcare

Static-site snapshot of **https://fairhealthcare.com.au**
...
# 3. Verify
docker ps | grep fair-healthcare
```
...
```
fair-healthcare.yourdomain.com {
    reverse_proxy fair-healthcare:80
}
```
